...
inputs = [
    ...
    gr.File(label="Upload the ATAC-seq file of the chosen chromosome"),
]
outputs = [
    gr.File(label="Find the prediction files under 'tmp/', which are used for visualization in the app."),
    gr.File(label="Find the prediction files under 'tmp/browser_data', which are used for visualization in the app.")
]
